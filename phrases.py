...
send_mem_text_to_me_2 = "Введите текст, который будет наложен на картинку, ещё раз"
...
max_text_len_info = lambda text_len: f"Макс. длина текста {text_len} симв."


user_pict_size = lambda size: f"Размеры Вашей картинки {size}, в px"
